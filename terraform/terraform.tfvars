region              = "ap-southeast-1"                     # Region AWS yang ingin digunakan
...
# Bonus (opsional)
# github_repo         = "<user>/<repo>"                     # ex: endrycofr/hello-terraform-ec2
# github_runner_token = "<TOKEN_SEMENTARA>"                 # token sementara dari GitHub Runner
